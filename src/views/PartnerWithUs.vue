...
.PartnerWithUs
  ...
  .main
    .container.container-sm
      ...
      .part2
        .paragraph-title.text-center Why host on Borocol?
        el-row.mtl(:gutter="30")
          el-col.part2-block.text-center(:span="8")
            .part2-block-icon
              span.icon.icon-earth
